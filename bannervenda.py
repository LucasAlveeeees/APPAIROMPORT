...
class BannerVenda(GridLayout):
    ...
    def __init__(self, **kwargs):
        ...
        esquerda_imagem = Image(pos_hint= {"right": 1,"top": 0.95} , size_hint=(1, 0.75),
                                source=f"icones/fotos_cliente/dia.png {foto_cliente}")
        ...
        meio_imagem = Image(pos_hint={"right": 1, "top": 0.95}, size_hint=(1, 0.75),
                                source=f"icones/fotos_produtos/feijao.png {foto_produto}")
        meio_imagem = Label(text=produto, size_hint=(1, 0.2), pos_hint={"right": 1, "top": 0.2})
        ...
        direita_label_preco=Label(text=f"preco:R${preco:,.2f}", size_hint=(1, 0.33), pos_hint={"right":1, "top":0.65})
